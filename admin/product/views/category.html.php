...
<div class="page-header">
    <div class="container-fluid">
        <div class="pull-right">
            <a class="btn btn-success " href="<?php echo url_for('/product/category.php?action=add'); ?>">
...
<script>
    function delete_category(title, id) {
        swal({
            ...
            $.post('<?php echo url_for('/product/category.php?action=delete'); ?>', {id: id}, function (data) {
