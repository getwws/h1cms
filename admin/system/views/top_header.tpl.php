<header class="header">
    ...
    <div class="flexbox flex-1">
        ...
        <ul class="nav navbar-toolbar">
            <li class="dropdown dropdown-inbox  d-none d-sm-none">
            ...
            <li class="dropdown dropdown-notification  d-none d-sm-none">
            ...
            <li class="dropdown dropdown-user">
                ...
                <ul class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="<?php echo url_for('/user/settings.php');?>"><i class="fa fa-cog"></i>系统设置</a>
