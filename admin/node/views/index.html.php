...
<div class="page-header">
    <div class="container-fluid">
        <div class="pull-right">
            <a class="btn btn-success " href="<?php echo url_for('/node/index.php?action=add'); ?>"><i class="fa fa-plus"></i> 添加文章</a>
        </div>
...
<form action="" method="get">
            ...
            <div class="card ">
                <div class="card-body">
                    ...
                    <?php
                    $search_list = [
                        'id' => '<i class="fa fa-fw fa-dot-circle-o mr-5"></i>文章ID',
                        'title' => '<i class="fa fa-fw fa-file mr-5"></i>文章标题'
                    ];
                        ...
                        while ($node = $nodes->fetchObject()) {
                            ...
                            <tr>
                                <td>
                                    ...
                                    <a class="font-w600"
                                       href="<?php echo url_for('/node/index.php?action=edit', ['id' => $node->node_id]); ?>"><?php echo $node->node_id; ?></a>
                                </td>
                                <td>
                                    <a class="font-w600"
                                       href="<?php echo url_for('/node/index.php?action=edit', ['id' => $node->node_id]); ?>"><?php echo $node->title; ?></a>
                                </td>
                                ...
                                <td class="actions">
                                    <a class="btn btn-default btn-sm" data-toggle="tooltip" title="编辑"
                                       href="<?php echo url_for('/node/?action=edit', ['id' => $node->node_id]); ?>"><i class="fa fa-pencil"></i>
                                    </a>
...
<script>
    ...
    function delete_node(title, id) {
        swal({
            ...
            $.post('<?php echo url_for('/node/index.php?action=delete'); ?>', {id: id}, function (data) {
